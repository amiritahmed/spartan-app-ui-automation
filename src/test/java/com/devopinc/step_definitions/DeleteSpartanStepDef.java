...
public class DeleteSpartanStepDef {
    ...
    public void verify_user_is_on_Spartan_List_page() {
        ...
        //String expectedUrl = "http://18.117.102.190:8000/web/v2/spartans";
        String expectedUrl = ConfigurationReader.getProperty("spartan.url")+"web/v2/spartans";
